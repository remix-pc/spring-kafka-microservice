...
public class KafkaConfig {
    ...
    public NewTopic paymentValidationSuccessTopic(){
        return buildTopic(PAYMENT_VALIDATION_SUCCESS.getTopic());
    }


    @Bean
    public NewTopic paymentValidationFailTopic(){
        return buildTopic(PAYMENT_VALIDATION_FAIL.getTopic());
    }
    ...
    public NewTopic inventorySuccessTopic(){
        return buildTopic(INVENTORY_VALIDATION_SUCCESS.getTopic());
    }

    @Bean
    public NewTopic inventoryFailTopic(){
        return buildTopic(INVENTORY_VALIDATION_FAIL.getTopic());
    }
